...
export class Board {
  ...
  addTestTask(status: 'to-do' | 'in-progress' | 'await-feedback' | 'done'): void {
    ...
    this.taskService.addDocument({
      ...
      description: 'Build start page with recipe recommendation Build start page with recipe recommendation. Kochwelt Page & Recipe RecommenderRecommenderRecommenderRecommenderKochwelt Page & Recipe RecommenderRecommenderRecommenderRecommender Kochwelt Page & Recipe RecommenderRecommenderRecommenderRecommender.',
      dueDate: Timestamp.fromDate(new Date(2026, 7, 20)),
      priority: 'low',
      assignees: ['1cDGsRRbp59SsjtonS2I', 'V2aQbKVzF7eFPsZfdhxB', 'V2aQbKVzF7eFPsZfdhxB', 'V2aQbKVzF7eFPsZfdhxB', 'V2aQbKVzF7eFPsZfdhxB', 'V2aQbKVzF7eFPsZfdhxB', 'V2aQbKVzF7eFPsZfdhxB', 'V2aQbKVzF7eFPsZfdhxB'],
      category: 'technical-task',
      subtasks: [
        { title: 'Kochwelt Page & Recipe RecommenderRecommenderRecommenderRecommender', done: false },
        { title: 'Sub 2', done: true },
        { title: 'Sub 2', done: true },
        { title: 'recipe recommendation Build start page', done: true },
        { title: 'Sub 2', done: true },
        { title: 'Kochwelt Page & Recipe RecommenderRecommenderRecommenderRecommender', done: true },
        { title: 'Sub 2', done: true },
        { title: 'Sub 2', done: true },
      ],
    });
